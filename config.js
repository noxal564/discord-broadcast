module.exports = {
    bot: {
        tokens: [
          "",              // Main bot token - Replace with your actual token
    ...
    server: {
        guildId: '1379541253015863499',         // ايدي السيرفر
        broadcastRoleId: '<@&1390444393319891055>', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1382885095286898718' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
